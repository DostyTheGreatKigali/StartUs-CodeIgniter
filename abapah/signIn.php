    ...
    public function updateProfile_post()
    {
        ...
        if (!empty($data)) {
            ...
            if (!empty($data['postal_code'])) {
                $bdata['postal_code'] = $data['postal_code'];
            }
            if (!empty($data['country'])) {
                $bdata['country'] = $data['country'];
            }

            if (!empty($data['first_name'])) {
                $udata['first_name'] = $data['first_name'];
            }
            if (!empty($data['last_name'])) {
                $udata['last_name'] = $data['last_name'];
            }
            if (!empty($data['phone'])) {
