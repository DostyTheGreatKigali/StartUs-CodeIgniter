...
class Package extends CI_Controller
{
    ...
    public function form($package_id = null)
    {
        ...
        $this->form_validation->set_rules('minimum_amount', display('minimum_amount'), 'required|max_length[11]');
        $this->form_validation->set_rules('maximum_amount', display('maximum_amount'), 'required|max_length[11]');
