...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?php echo base_url('customer/home') ?>" class="logo">
                <!-- Logo -->
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview account">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li style="display: none"><a href="<?php echo base_url('customer/commission/team_bonus') ?>"><?php echo display('team_bonus') ?></a></li>
                    ...
                    <li class="treeview finance">
                        ...
                        <ul class="treeview-menu">
                            <li style="display: none"><a href="<?php echo base_url('customer/transfer') ?>"><?php echo display('transfer') ?></a></li>
                            <li style="display: none"><a href="<?php echo base_url('customer/transfer/transfer_list') ?>"><?php echo display('transfer_list') ?></a></li>
